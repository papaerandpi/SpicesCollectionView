...
static NSString * const SpiceLayoutPhotoCellKind = @"PhotoCell";

@interface SpiceLayout ()

@property (nonatomic, strong) NSDictionary *layoutInfo;

@end

@implementation SpiceLayout
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[SpiceLayoutPhotoCellKind] = cellLayoutInfo;
...
{
    return self.layoutInfo[SpiceLayoutPhotoCellKind][indexPath];
}
